...
- Stratification of currencies that cannot be exchanged for one another
  ...
  - small sums of money as an acknowledgement of an unpayable debt (bridewealth)
- Primordial debt theory
- Unpayable debts
  - Debt to society
  - Debt to parents
  - hospitality as a debt to others/ the hospitality shown to you by others 
    - similar to the concept of couch surfing but needing to entertain the host with a story from your travels 
- shield story where a friend gifts an shield and essentially makes a friend forever in debt, so the friend tries to kill him
- Social systems of debt around people
  - wives made to work for creditors/masters for a time and only then to be given to the husbands

- Nasruddin
  - Gift for a king story -> turnips 
  - Unbreakable glass 

- A common currency effectively eliminates aristocratic barrier to status 




- Emotion around debt
  - Swapping things and trying to get the best deal is something someone would do with people they do not care about or do not plan to see again
  - Neighborly debt such that gifts of various kinds are exchanged
    - neighbors establish a sort of credit with each other 
      - this could potentially be used strategically to one's advantage
    - Giving a gift exactly equivalent in value would mean you want nothing to do with another person
  - True charity is anonymous such that the recipient is not actually in debt
  - Debt is what happens in between no relationship and eventual departure
  - "Thank you" signifies that the other person might not have acted that way and thus acknowledges an obligation has been created 


- Kings and slaves are two ends of the spectrum "completely isolated by their relation to power" 
  - There is no debt a king cannot pay?
  - There is no debt a slave can pay?
  - Everyone else is engaged in a network of credits and debts


- Debt of life to be paid with sacrifice and eventual death


- Human original sin:
  - The maximalist Christian god with the debt that can never be discharged
  - "Stroke of genius of Christianity"
    1. God sacrifices himself for the guilt of humans (death of Jesus -> he is God embodied and says "I will die for your sins")
      -> God paying himself back with himself (then the "receipt" being the resurrection)
    3. The creditor sacrificing himself for the debtor out of love (in the selfish sense this doesn't make sense)
      God as the only one who can redeem man from (what for human beings) is an impossible debt to repay 
...
- Are you indebted by the benefits/tailwinds/privileges that you have been born into?
- How much is our death worth in terms of servicing the debt of birth? Are we just paying interest by participating in humanity every day? Are we judged by our balance at the end of our life?
- Do you have the freedom to decide how you repay your debt to society?
  - You might have human freedom to pay as you wish, but is this accepted the same? 
  - How much say does a creditor have in how they are repaid?
  - Does one really have the opportunity to repay as they wish?
- Should we have permanent power to extract a service or a good? Isn't this effectively slavery / ownership over the producer?
  - Have we developed past an ownership based model and arrived closer to a debt exchange? (Technofeudalism temporary usage)
...
I feel that contemporary life is marked by this notion of Technofeudalism that our standard of living is ever improving and consequently the resources in both material and labor are expanding. As we strive for a higher and higher standard of living, it demands that we earn more and more. It's not quite  a debt peonage system, but even if you are not in debt, but feel an obligation to consume and acquire more with no sense that you can rest the behavior is the same of continually being obligated to work. It is a sort of psychological debt and this is where Technofeudalism comes in. Because nothing is owned, though you are not in debt, anything you "have" is only had temporarily. So if you were to exit the system, you have no obligation to another person, however attachment to a standard of living demands that you're earning potential must be ever increasing. 
